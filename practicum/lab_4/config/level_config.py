...
level_1 = Level()
level_1.set_back('icon/cave.png')
...
level_2.set_back('icon/jungle.png')
...
level_2.add_enemy(0, 1200, 250, 1100, 1400, 2)
level_2.add_enemy(1, 1800, 100, 1700, 1950, 5)
level_2.add_enemy(0, 2200, 400, 2000, 2400, 3)
level_2.add_enemy(1, 2900, 200, 2800, 3100, 6)

# Платформы (некоторые двигаются)
level_2.add_platform(0, 550, 300, 100, 35, 0, 0)  # Стартовая платформа
level_2.add_platform(400, 450, 250, 100, 5, 0, 0)  # Обычная платформа
level_2.add_platform(800, 300, 300, 50, 10, 0, -2)  # Поднимается и опускается
level_2.add_platform(1100, 550, 250, 100, 5, 0, 0)
level_2.add_platform(1400, 250, 200, 50, 5, 0, -3)  # Двигается вверх-вниз
level_2.add_platform(1700, 400, 250, 100, 5, 0, 0)
level_2.add_platform(2100, 500, 300, 50, 7, -2, 0)  # Двигается влево-вправо
level_2.add_platform(2500, 400, 200, 50, 5, 0, -3)  # Двигается вверх-вниз
level_2.add_platform(2800, 550, 250, 100, 5, 0, 0)

# Финиш
level_2.set_goal(3000, 400)
