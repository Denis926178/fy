...
class BaseSprite(pygame.sprite.Sprite):
    ...
    def change_dir(self): ####### changee_direction можно спутать с directory
        self.x_speed *= -1
        self.direction *= -1 

    def change_ydir(self): ####### change_y_direction - можно спутать с directory
        self.y_speed *= -1
...
class Character(BaseSprite):
    ...
    def check_dir(self): ###### аналогично direction, а не dir
